  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Divider */}
        <div style={{ borderTop: "1px solid #2a2d3a", marginBottom: 28 }} />
        ...
        >
          <div style={{ flex: 1, borderTop: "1px solid #2a2d3a" }} />
        ...
        <button
          ...
          onMouseEnter={(e) => {
            if (!loading) (e.currentTarget as HTMLButtonElement).style.backgroundColor = "#252840";
          }}
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLButtonElement).style.backgroundColor = "#1e2130";
          }}
        >
          <GitHubIcon />
